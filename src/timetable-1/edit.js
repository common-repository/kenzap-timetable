...
export default class Edit extends Component {
    ...
    /**
     * Update filter textual value
     */
    filterUpdate = (filterType, index) => {

        const filters = [...this.props.attributes[filterType]];
        filters[index].name = event.target.value;
        this.props.setAttributes({[filterType]: filters});
    }
                            ...
                            {['classFilters', 'monthFilters'].map(filterType => {
                                    return (
                                        <div style={{ marginBottom: '25px' }}>
                                                ...
                                                <div key={filter.value}>
                                                    ...
                                                    >
                                                        ...
                                                        <input 
                                                            value={filter.name}
                                                            type="text"
                                                            onChange={this.filterUpdate.bind(this, filterType, index)}
                                                            >
                                                        </input>
                                            ...
                                            >
                                                <span style={{lineHeight: 0.8, marginRight: '5px'}}><Plus/></span>
